...
public class UserInputPageRR extends Panels implements ActionListener{
    ...
    public JTextField inputField, processIDField, burstField, arrivalField, quantumField;
